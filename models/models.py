...
cpu1 = tensorflow.config.experimental.list_physical_devices(device_type='CPU')
tensorflow.config.experimental.set_visible_devices(devices= cpu1, device_type='CPU')
