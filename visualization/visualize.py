...
def plot_to_tensor():
    ...
    image_tensor = tensorflow.image.decode_png(buf.getvalue(), channels=4)     # Convert .png buffer to tensorflow image
    image_tensor = tensorflow.expand_dims(image_tensor, 0)     # Add the batch dimension
    return image_tensor
